...
export default class EditClassStory extends Component {
 ...
 loadStory()
 {
  ...
  /* Call function class story teache service to get post */
  ...
  ImagePicker.showImagePicker(options, (response) => {
    ...
    if (response.didCancel) {
      ...
      let source = response.uri;
        /* Set state for display profile */
        this.setState({ ImageSource: source });
        let sourcedes = { uri: response.uri };
        /* Set state for upload image */
        this.setState({
...
/* Edit Class story */
 EditStory(){
  ...
  render() {
    ...
    /* Display image/video in time to upload */
